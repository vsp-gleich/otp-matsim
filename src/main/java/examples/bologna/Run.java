...
public class Run {
    ...
    public static final String TRANSIT_SCHEDULE_FILE = BASEDIR + "extracted-transitschedule.xml";
    /** Created by ExtractNetwork*/
    public static final String TRANSIT_VEHICLE_FILE = BASEDIR + "extracted-transitvehicles.xml";
    /** Created by ExtractNetwork*/
    public static final String NETWORK_FILE = BASEDIR + "extracted-network.xml";
    ...
    public static final String OUTPUT_DIR = BASEDIR + "testOneIteration";
